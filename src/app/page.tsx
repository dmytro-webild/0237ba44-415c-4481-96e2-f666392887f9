...
import { Award, Coffee, Croissant, Instagram, MessageCircle, Sparkles } from "lucide-react";
...
export default function LandingPage() {
      ...
      avatars={[
        {
          ...
          alt: "Customer portrait smiling coffee cafe",
        },
        {
        ...
        },
        {
          ...
          alt: "Man reading book cafe coffee",
        },
        {
          ...
          alt: "Close up indoor photo of smiling happy woman",
        },
      ]}
      buttons={[
        {
  ...
  <div id="social-proof" data-section="social-proof">
      ...
      names={[
        "The Daily Grind",
        "Urban Coffee Reviews",
        "City Lifestyle Guide",
        "Coffee Connoisseur",
        "Modern Cafe Critics",
        "Local Brew Experts",
        "Atmosphere Weekly",
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          price: "$6.00",
          imageSrc: "http://img.b2bpic.net/free-photo/glass-with-iced-coffee-table_23-2148937324.jpg",
        },
        {
          id: "3",
          name: "Cold Brew",
        ...
        },
        {
          ...
          price: "$6.50",
          imageSrc: "http://img.b2bpic.net/free-photo/pancake-chocolate-cake-with-fresh-raspberries-pink-background_127032-3556.jpg",
        },
      ]}
      title="The Selection"
  ...
  <div id="gallery" data-section="gallery">
      ...
      features={[
        {
          title: "Coffee Craft",
          description: "The art of the perfect brew.",
          imageSrc: "http://img.b2bpic.net/free-photo/roasted-coffee-beans-close-up_84443-72341.jpg",
          buttonIcon: "Camera",
        },
        {
          title: "Interior Design",
          description: "Designed for conversations and focus.",
      ...
      metrics={[
        {
          ...
          value: "100%",
          title: "Premium Beans",
          description: "Ethically sourced quality.",
        ...
        },
        {
          ...
          value: "Cinematic",
          title: "Atmosphere",
          description: "Designed for your moments.",
        ...
        },
        {
          ...
          value: "Fast",
          title: "Service",
          description: "Attention without delay.",
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-roasted-coffee-beans_1149-788.jpg",
        },
      ]}
